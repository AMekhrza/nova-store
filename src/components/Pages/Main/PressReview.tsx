...
const PressReview = (): React.ReactElement => {
  const pressReviewsArray = [
    ...
    },
    {
      id: 2,
      review:
        "Fashionista Magazine highlights Nova Store's diverse range of clothing and accessories, noting its intuitive interface and trend-setting offerings",
    ...
    },
    {
      id: 3,
      review:
        "In a nod to Nova Store's fashion-forward approach, Glamour Magazine commends its seamless integration of clothing and accessories, catering to style-savvy shoppers",
    ...
    },
    {
      id: 4,
      review:
        'Vogue lauds Nova Store for its extensive collection of clothing and accessories, delivering a streamlined shopping experience for fashion enthusiasts.',
    ...
    },
    {
      id: 5,
      review:
        "We praise Nova Store's blend of clothing and accessories, celebrating its curated selection and user-friendly platform",
